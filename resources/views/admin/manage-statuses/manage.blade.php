@include('templates.header')
  ...
  <title>Manage Status | Asset Management and Procurement System</title>
</head>
...
<body>
	...
	<div class="dboard-container">
		...
		<div class="dboard-right-panel fr">
			...
			<div class="dboard-content-menu">
				<a href="{{ route('statuses.create') }}" class="dboard-add-acc fl">Create New Status</a>
					...
					<thead>
						...
						@foreach ($statuses as $status)
							<tr>
								...
								<td>
									<a href="{{ route('statuses.show', $status->id) }}" class="manage-view-but" title="View Status">View</a>
									<a href="{{ route('statuses.edit', $status->id) }}" class="manage-edit-but" title="Edit Status">Edit</a>
	...
	{{-- <div class="manage-archive-confirmation">
		<div class="manage-popup-cont">
			<p>Are you sure you want to archive the status?</p>
			<form action="{{ route('statuses.destroy', $status->id) }}" method="POST" style="display: inline;">
				{{ csrf_field() }}
				{{ method_field('DELETE') }}
