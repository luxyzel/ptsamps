...
@include('templates.header')
  ...
  <title>Show Conditions | Asset Management and Procurement System</title>
</head>
      ...
      {{-- TOP LABELS --}}
        <div class="login-title">
            ...
            <div class="login-text fl">
                <p class="login-comp-nm">Show Condition Info</p>
                
            </div>
            <div class="clr"></div>
        </div>
        <div class="view-container">
            <label class="lbl-view">Condition</label>
            <p class="view-label">{{$condition->condition}}</p>
