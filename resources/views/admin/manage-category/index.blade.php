    ...
    <div class="dboard-container">
        ...
        <div class="dboard-right-panel fr">
            ...
            <div class="dboard-content-menu">
                 <a href="{{ route('category.create') }}" class="dboard-add-acc fl" style="margin-left: 10px;">Create Category</a>
                <a href="{{ route('conditions.index') }}" class="dboard-add-acc fl" style="margin-left: 10px;">Conditions</a>
                <a href="{{ route('statuses.index') }}" class="dboard-add-acc fl" style="margin-left: 10px;">Status</a>
                <a href="{{ route('locations.index') }}" class="dboard-add-acc fl" style="margin-left: 10px;"> Locations</a>
                <div class="clr"></div>
            </div>
                    ...
                    <thead>
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('category.edit', $category->id) }}" class="manage-edit-but" title="Edit Condition">Edit</a>
