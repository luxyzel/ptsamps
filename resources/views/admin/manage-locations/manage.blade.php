...
@include('templates.header')
  ...
  <title>Manage Location | Asset Management and Procurement System</title>
</head>
...
<body>
	...
	<div class="dboard-container">
		...
		<div class="dboard-right-panel fr">
			...
			<div class="dboard-content-menu">
				<a href="{{ route('locations.create') }}" class="dboard-add-acc fl">Create New Location</a>
					...
					<thead>
						...
						@foreach ($locations as $location)
							<tr>
								...
								<td>
									<a href="{{ route('locations.show', $location->id) }}" class="manage-view-but" title="View Location">View</a>
									<a href="{{ route('locations.edit', $location->id) }}" class="manage-edit-but" title="Edit Location">Edit</a>
	...
	{{-- <div class="manage-archive-confirmation">
		<div class="manage-popup-cont">
			<p>Are you sure you want to archive the location?</p>
			<form action="{{ route('locations.destroy', $location->id) }}" method="POST" style="display: inline;">
				{{ csrf_field() }}
				{{ method_field('DELETE') }}
