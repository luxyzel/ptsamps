@include('templates.header')
    ...
    <title>Pending PO | Asset Management and Procurement System</title>
</head>
				...
				<table style="width: 100%; text-align: center;">
					<thead>
						...
						<tr>
							...
							<td>
								<a href="{{ route('pending-po.edit', $procure->group_id) }}" class="manage-view-but" title="View">View Details</a>
							</td>
						</tr>
					@endforeach
				</table>
