...
<body>
    ...
    <div style="width: 1200px; margin: auto;">
        <p class="app-page-name" style="font-size: 30px; margin-top: 20px;">View Approved Purchase Order {{$payments->pos->po_number}}</p>
        ...
        {{csrf_field()}}
            ...
            <a href="{{ route('approved-po.index') }}" class="po-back-page">Back To Previous Page</a>
        </form>
