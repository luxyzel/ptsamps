@include('templates.header')
    ...
    <title>Rejected PO | Asset Management and Procurement System</title>
</head>
...
<body>
    ...
    <div class="dboard-container">
        ...
        <div class="dboard-right-panel fr">
        	...
        	<div class="app-label">
                <div class="fl">
                    <p class="app-page-name">Rejected P.O.</p>
                </div>
                <div class="fl">
				...
				<table style="width: 100%; text-align: center;">
					<thead>
						...
						<tr>
							...
							<td>
								<a href="{{ route('rejected-po.show', $procure->group_id) }}" class="manage-view-but" title="View">View Details</a>
							</td>
						</tr>
					@endforeach
				</table>
