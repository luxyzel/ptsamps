...
<body>
	...
	<div style="width: 1200px; margin: auto;">
        <p class="app-page-name" style="font-size: 30px; margin-top: 20px;">View Rejected PO Request</p>
        ...
        {{csrf_field()}}
            ...
            <a href="{{ route('rejected-po.index') }}" class="po-back-page">Back To Previous Page</a>
        </form>
